...
class MorphologyApp(QMainWindow):
    def __init__(self):
        ...
        self.setGeometry(100, 100, 900, 500)  # Ukuran yang lebih besar untuk tata letak yang lebih baik
        ...
        self.apply_button.setEnabled(False)  # Nonaktifkan tombol sampai gambar diunggah
        ...
        self.original_image_label.setFixedSize(400, 300)  # Ukuran disesuaikan untuk tampilan yang lebih baik
        ...
        self.processed_image_label.setFixedSize(400, 300)  # Ukuran disesuaikan untuk tampilan yang lebih baik
